...
export const dialogueData = {
  ...
  bed: `This where I sleep. I like my bed! It keeps my mind sharp and most of my great ideas come to me during my dreams.`,

  resume: `This is my desk and on it is my resume. <a href="https://github.com/JohnnyHackz" target="_blank">Check it out?</a>
    Contact me at <button id="copyEmailResume">berentsenjakob@gmail.com</button> if you have any interesting job opportunities!`,
